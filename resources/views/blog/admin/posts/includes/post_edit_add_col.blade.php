...
<div class="row justify-content-center">
	<div class="col-md-12">
		<div class="card rounded-0 shadow">
			<div class="card-body">
				<button type="submit" class="btn btn-primary info-btn rounded-0 btn-block">Сохранить
		...
		<div class="col-md-12">
			<div class="card rounded-0 shadow">
				...
				<div class="form-group">
					...
					<input type="text" value="{{ $item->published_at }}" class="form-control rounded-0" disabled>
				</div>	
